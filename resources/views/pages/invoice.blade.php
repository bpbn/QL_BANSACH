                            ...
                            <form class="needs-validation" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="firstName" class="form-control" id="firstName" placeholder="Họ" value="<?php echo $first_name; ?>" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="user_lastName" class="form-control" id="lastName" placeholder="Tên" value="<?php echo $last_name; ?>" required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="username" placeholder="Tên tài khoản!" value="{{ Auth::user()->name }}" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="user_email" class="form-control" id="email" placeholder="Vui lòng nhập email!" value="{{ Auth::user()->email }}">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="ShippingAddress" class="form-control" id="address" placeholder="Vui lòng nhập địa chỉ!" value="{{ Auth::user()->address }}" required>
                                    <div class="invalid-feedback">
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="{{ $ca->book_id }}">
                                            ...
                                            <td data-th="Subtotal" class="text-center">
                                                <h5 class="nomargin" style="margin-left: 20px;">{{ number_format($ca->price * $ca->quantity, 0, ',', '.') }}</h5>
                                ...
                                <div class="d-block my-3">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="debit">Thanh toán qua mã QR</label>

                                    </div>
                                    <img id="qrImage" src="" alt="QR Code" style="width: 300px; height: 300px; display: none;">
                                </div>
                                <hr class="mb-4">
                                <button onclick="handleAddToInvoice(event)" class="btn btn-primary btn-lg btn-block mb-2" type="submit">Đặt hàng</button>
